...
public:
    ...
    std::unique_ptr<SE::Shader> shader{ new SE::Shader{ "SandboxEngine/SandboxEngine/src/Graphics/shaders/primitive.vert","SandboxEngine/SandboxEngine/src/Graphics/shaders/primitive.frag"}};
